...
public class ChangePasswordMisMatchPasswordTest
{
    ...
    public void verifyChangePassword()
    {
        ...
        passwordPage.passwordChange(basePage.properties.getProperty("currentPassword"),
                basePage.properties.getProperty("newPassword"),basePage.properties.getProperty("mismatchConfirmPassword"));
        Assert.assertTrue(passwordPage.passwordMismatchErrorMessage.isDisplayed(),"Error message not displayed for mismatch confirm password field");
    }
