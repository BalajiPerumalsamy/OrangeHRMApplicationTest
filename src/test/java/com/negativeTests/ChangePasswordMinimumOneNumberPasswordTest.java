...
public class ChangePasswordMinimumOneNumberPasswordTest
{
    ...
    public void verifyChangePassword()
    {
        ...
        passwordPage.passwordChange(basePage.properties.getProperty("currentPassword"),
                basePage.properties.getProperty("numberNewPassword"),basePage.properties.getProperty("numberConfirmPassword"));
        Assert.assertTrue(passwordPage.minimumOneLowerCaseLetterErrorMessage.isDisplayed(),"Error message not displayed for enter minimum one number new password field");
    }
